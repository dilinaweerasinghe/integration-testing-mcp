---
description: 'Expert agent for creating SAR/TAR (Service Automation REST / Test Automation REST) test utilities and test cases for IFS Cloud integration testing.'
tools: ['edit', 'search', 'new', 'runCommands', 'problems', 'changes']
---
